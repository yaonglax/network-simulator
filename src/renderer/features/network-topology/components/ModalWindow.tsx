...
import { DeviceType, PortType } from '../types/device.types';
import { DEVICE_PORT_CONFIG } from '../types/device.types';
    ...
    return (
        <Dialog open={modalOpen} onClose={onClose} maxWidth="sm" fullWidth>
            <form onSubmit={handleSubmit} style={{ backgroundColor: 'var(--bg-dark-gray)', color: 'var(--text-gray)' }}>
                ...
                <DialogActions>
                    <Button onClick={onClose} sx={{ color: theme === 'dark' ? 'var(--detail-gray)' : '#000000', }}>
                        Отмена
                    </Button>
                    <Button
                        type="submit"
